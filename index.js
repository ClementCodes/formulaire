...
// le inpUtilisateur  signifie donc le premier enfant input de la portée formgroup et bien tu le prends  "les ciblings"
...
// toute les lis div qu il y a l interieur de la ligne
...
let valeurInp;
//tout les caracteres qui ne sont pas spaeciaux
const specialCar = /[^a-zA-Z0-0]/;
// le peit i veut dire insensitive donc insensible a la casse donc au majuscule et au minuscule
//toutes les les lettrres en minuscules ais graces au petit i ont prend aussi les majuscules pour signaler l insensibilité a la casse
const alphabet = /[a-z]/i;
//tout les chiffres
const chiffres = /[0-9]/i;
...
inpMdp.addEventListener("input", (e) => {
  ...
  //e.inputType ='deletecontentBackward'  est une propriete de l event e qui permet de savoir lorsque l on suppprime des lettres de l input
